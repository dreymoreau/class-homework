...
// (for example, "b"). The first character has position 0, which causes the last one to be found at position string.length - 1. 
...
function countBs (stringToNum) {
    let product = stringToNum;

    return string[product];
}

console.log(countBs('This is a Big string'))